...
### What is this?
baddaub is daub injected into badrecovery unverified, allowing for update blocking on keyrolled ChromeOS devices. baddaub is a fork of [badsh1mmer](https://github.com/crosbreaker/badsh1mmer)
...
Complete sh1ttyoobe, sh1ttyexec, or any oher method for booting unverified recovery images then enter developer mode and recover to your usb, choose to block updates and then reboot and updates will be blocked!
### Credits:
